...
int main()
{
    ...
    const int nq_span = lgm_model.getNumPositions();
    ...
    std::cout << "\nydd_grbda    : " << ydd_cluster.transpose() << std::endl;
    std::cout << "qdd_pinocchio: " << data.ddq.transpose() << std::endl;
    std::cout << "qdd_grbda    : " << qdd_grbda.transpose() << std::endl;

    // Do the solutions satisfy the loop constraints?
    ...
    std::cout << "\nK*qdd_pinocchio + k: " << cnstr_violation_pinocchio.transpose() << std::endl;
    std::cout << "K*qdd_grbda + k    : " << cnstr_violation_grbda.transpose() << std::endl;
