...
bar(x - 2 * offset, data(:, 3), barWidth, 'FaceColor', subdued_yellow, 'DisplayName', 'Approximate ABA');
bar(x, data(:, 2), barWidth,  'FaceColor', subdued_red, 'DisplayName', 'Constraint-Embedding ABA (Ours)');
...
xticks(x)
xticklabels({'Mini Cheetah', 'MIT Humanoid'})
