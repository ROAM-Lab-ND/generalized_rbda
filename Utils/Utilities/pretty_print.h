...
template<typename T>
void pretty_print(const T & v, std::ostream & os, std::string const & title, 
    std::string const & prefix = ""){
  os<<prefix<<pretty_string(v)<<"\n";
}
...
template <typename T>
void pretty_print(Mat13<T> const &vv, std::ostream &os, std::string const &title,
                  std::string const &prefix = "", bool nonl = false) {
  pretty_print((DMat<T> const &)vv, os, title, prefix, false, nonl);
}

template <typename T>
void pretty_print(Mat1312<T> const &vv, std::ostream &os, std::string const &title,
                  std::string const &prefix = "", bool nonl = false) {
  pretty_print((DMat<T> const &)vv, os, title, prefix, false, nonl);
}
...
template <typename T>
void pretty_print(Vec5<T> const &vv, std::ostream &os, std::string const &title,
                  std::string const &prefix = "", bool nonl = false) {
  pretty_print((DMat<T> const &)vv, os, title, prefix, true, nonl);
}

template <typename T>
void pretty_print(Vec12<T> const &vv, std::ostream &os, std::string const &title,
                  std::string const &prefix = "", bool nonl = false) {
  pretty_print((DMat<T> const &)vv, os, title, prefix, true, nonl);
}

template <typename T>
void pretty_print(Vec13<T> const &vv, std::ostream &os, std::string const &title,
                  std::string const &prefix = "", bool nonl = false) {
  pretty_print((DMat<T> const &)vv, os, title, prefix, true, nonl);
}
