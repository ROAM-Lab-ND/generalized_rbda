...
namespace LCMTypes
{
    public sealed class humanoid_state_info_lcmt : LCM.LCM.LCMEncodable
    {
        ...
        public static readonly ulong LCM_FINGERPRINT_BASE = 0x1b2eb82c13b6687aL;
 
        static humanoid_state_info_lcmt()
        {
        ...
        {
            if (classes.Contains("LCMTypes.humanoid_state_info_lcmt"))
                return 0L;
 
            classes.Add("LCMTypes.humanoid_state_info_lcmt");
        ...
        public humanoid_state_info_lcmt(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public humanoid_state_info_lcmt(LCMDataInputStream ins)
        {
        ...
        public static LCMTypes.humanoid_state_info_lcmt _decodeRecursiveFactory(LCMDataInputStream ins)
        {
