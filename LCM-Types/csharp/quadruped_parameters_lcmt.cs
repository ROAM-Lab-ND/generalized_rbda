...
namespace LCMTypes
{
    public sealed class quadruped_parameters_lcmt : LCM.LCM.LCMEncodable
    {
        ...
        public quadruped_parameters_lcmt()
        {
        }
 
        public static readonly ulong LCM_FINGERPRINT;
        public static readonly ulong LCM_FINGERPRINT_BASE = 0x88279a1f772681d7L;
 
        static quadruped_parameters_lcmt()
        {
        ...
        {
            if (classes.Contains("LCMTypes.quadruped_parameters_lcmt"))
                return 0L;
 
            classes.Add("LCMTypes.quadruped_parameters_lcmt");
        ...
        public quadruped_parameters_lcmt(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public quadruped_parameters_lcmt(LCMDataInputStream ins)
        {
        ...
        public static LCMTypes.quadruped_parameters_lcmt _decodeRecursiveFactory(LCMDataInputStream ins)
        {
            LCMTypes.quadruped_parameters_lcmt o = new LCMTypes.quadruped_parameters_lcmt();
        ...
        public LCMTypes.quadruped_parameters_lcmt Copy()
        {
            LCMTypes.quadruped_parameters_lcmt outobj = new LCMTypes.quadruped_parameters_lcmt();
