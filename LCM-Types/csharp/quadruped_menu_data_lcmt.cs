...
namespace LCMTypes
{
    public sealed class quadruped_menu_data_lcmt : LCM.LCM.LCMEncodable
    {
        ...
        static quadruped_menu_data_lcmt()
        {
        ...
        {
            if (classes.Contains("LCMTypes.quadruped_menu_data_lcmt"))
                return 0L;
 
            classes.Add("LCMTypes.quadruped_menu_data_lcmt");
        ...
        public quadruped_menu_data_lcmt(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public quadruped_menu_data_lcmt(LCMDataInputStream ins)
        {
        ...
        public static LCMTypes.quadruped_menu_data_lcmt _decodeRecursiveFactory(LCMDataInputStream ins)
        {
