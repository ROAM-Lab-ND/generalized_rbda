...
namespace LCMTypes
{
    public sealed class tello_parameters_lcmt : LCM.LCM.LCMEncodable
    {
        ...
        {
            if (classes.Contains("LCMTypes.tello_parameters_lcmt"))
                return 0L;
 
            classes.Add("LCMTypes.tello_parameters_lcmt");
        ...
        public tello_parameters_lcmt(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public tello_parameters_lcmt(LCMDataInputStream ins)
        {
        ...
        public static LCMTypes.tello_parameters_lcmt _decodeRecursiveFactory(LCMDataInputStream ins)
        {
