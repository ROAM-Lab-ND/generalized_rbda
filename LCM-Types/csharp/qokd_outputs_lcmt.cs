...
namespace LCMTypes
{
    public sealed class qokd_outputs_lcmt : LCM.LCM.LCMEncodable
    {
        ...
        {
            if (classes.Contains("LCMTypes.qokd_outputs_lcmt"))
                return 0L;
 
            classes.Add("LCMTypes.qokd_outputs_lcmt");
        ...
        public qokd_outputs_lcmt(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public qokd_outputs_lcmt(LCMDataInputStream ins)
        {
        ...
        public static LCMTypes.qokd_outputs_lcmt _decodeRecursiveFactory(LCMDataInputStream ins)
        {
            LCMTypes.qokd_outputs_lcmt o = new LCMTypes.qokd_outputs_lcmt();
        ...
        public LCMTypes.qokd_outputs_lcmt Copy()
        {
            LCMTypes.qokd_outputs_lcmt outobj = new LCMTypes.qokd_outputs_lcmt();
