...
namespace LCMTypes
{
    public sealed class taqokd_inputs_lcmt : LCM.LCM.LCMEncodable
    {
        ...
        public static readonly ulong LCM_FINGERPRINT_BASE = 0x0b822b6405fb66c1L;
 
        static taqokd_inputs_lcmt()
        {
        ...
        {
            if (classes.Contains("LCMTypes.taqokd_inputs_lcmt"))
                return 0L;
 
            classes.Add("LCMTypes.taqokd_inputs_lcmt");
        ...
        public void _encodeRecursive(LCMDataOutputStream outs)
        {
            ...
            for (int a = 0; a < 2; a++) {
                outs.Write(this.r_land_xy_sf[a]); 
            }
            ...
            outs.Write(this.terrain_z_height_actual); 
 
            outs.Write(this.terrain_z_height); 
 
            outs.Write(this.terrain_x_shift_actual); 
 
            outs.Write(this.terrain_x_shift); 
 
            outs.Write(this.terrain_steepness); 
 
            outs.Write(this.terrain_y_angle); 
 
            outs.Write(this.terrain_y_curvature); 
        ...
        public taqokd_inputs_lcmt(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public taqokd_inputs_lcmt(LCMDataInputStream ins)
        {
        ...
        public static LCMTypes.taqokd_inputs_lcmt _decodeRecursiveFactory(LCMDataInputStream ins)
        {
        ...
        public LCMTypes.taqokd_inputs_lcmt Copy()
        {
            ...
            for (int a = 0; a < 2; a++) {
                outobj.r_land_xy_sf[a] = this.r_land_xy_sf[a];
            }
