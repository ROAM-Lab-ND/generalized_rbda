...
namespace LCMTypes
{
    public sealed class leg_control_data_lcmt : LCM.LCM.LCMEncodable
    {
        public float[] q;
        public float[] qd;
        public float[] p;
        ...
        public leg_control_data_lcmt()
        {
            ...
            tau_act = new float[12];
        }
 
        public static readonly ulong LCM_FINGERPRINT;
        public static readonly ulong LCM_FINGERPRINT_BASE = 0xc1debc79b6653dd7L;
 
        static leg_control_data_lcmt()
        {
        ...
        {
            if (classes.Contains("LCMTypes.leg_control_data_lcmt"))
                return 0L;
 
            classes.Add("LCMTypes.leg_control_data_lcmt");
        ...
        public leg_control_data_lcmt(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public leg_control_data_lcmt(LCMDataInputStream ins)
        {
        ...
        public static LCMTypes.leg_control_data_lcmt _decodeRecursiveFactory(LCMDataInputStream ins)
        {
        ...
        public LCMTypes.leg_control_data_lcmt Copy()
        {
            ...
            outobj.tau_act = new float[(int) 12];
            for (int a = 0; a < 12; a++) {
