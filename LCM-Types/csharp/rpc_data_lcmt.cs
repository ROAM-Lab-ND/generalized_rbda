...
namespace LCMTypes
{
    public sealed class rpc_data_lcmt : LCM.LCM.LCMEncodable
    {
        ...
        public static readonly ulong LCM_FINGERPRINT_BASE = 0xf933cc03f4843206L;
 
        static rpc_data_lcmt()
        {
        ...
        {
            if (classes.Contains("LCMTypes.rpc_data_lcmt"))
                return 0L;
 
            classes.Add("LCMTypes.rpc_data_lcmt");
        ...
        public rpc_data_lcmt(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public rpc_data_lcmt(LCMDataInputStream ins)
        {
        ...
        public static LCMTypes.rpc_data_lcmt _decodeRecursiveFactory(LCMDataInputStream ins)
        {
