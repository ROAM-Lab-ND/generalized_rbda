...
namespace LCMTypes
{
    public sealed class qkdif_inputs_lcmt : LCM.LCM.LCMEncodable
    {
        ...
        public static readonly ulong LCM_FINGERPRINT_BASE = 0xc37c31a01d17abc7L;
 
        static qkdif_inputs_lcmt()
        {
        ...
        {
            if (classes.Contains("LCMTypes.qkdif_inputs_lcmt"))
                return 0L;
 
            classes.Add("LCMTypes.qkdif_inputs_lcmt");
        ...
        public void _encodeRecursive(LCMDataOutputStream outs)
        {
            ...
            outs.Write(this.r_land_height); 
 
            for (int a = 0; a < 2; a++) {
                outs.Write(this.dist_past_obs[a]); 
            }
 
            for (int a = 0; a < 3; a++) {
                outs.Write(this.rpy_land_min[a]); 
            }
 
            for (int a = 0; a < 3; a++) {
                outs.Write(this.rpy_land_max[a]); 
            }
 
            outs.Write(this.obs_height_actual); 
 
            outs.Write(this.obs_height); 
 
            outs.Write(this.dist_to_obs_actual); 
 
            outs.Write(this.dist_to_obs); 
 
            outs.Write(this.terrain_steepness); 
        ...
        public qkdif_inputs_lcmt(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public qkdif_inputs_lcmt(LCMDataInputStream ins)
        {
        ...
        public static LCMTypes.qkdif_inputs_lcmt _decodeRecursiveFactory(LCMDataInputStream ins)
        {
        ...
        public LCMTypes.qkdif_inputs_lcmt Copy()
        {
            ...
            for (int a = 0; a < 2; a++) {
                outobj.dist_past_obs[a] = this.dist_past_obs[a];
            }
 
            outobj.rpy_land_min = new double[(int) 3];
            for (int a = 0; a < 3; a++) {
                outobj.rpy_land_min[a] = this.rpy_land_min[a];
            }
 
            outobj.rpy_land_max = new double[(int) 3];
            for (int a = 0; a < 3; a++) {
                outobj.rpy_land_max[a] = this.rpy_land_max[a];
            }
