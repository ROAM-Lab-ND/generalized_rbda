...
#ifndef __tello_parameters_lcmt_hpp__
#define __tello_parameters_lcmt_hpp__

#include <lcm/lcm_coretypes.h>



class tello_parameters_lcmt
{
    public:
...
int tello_parameters_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int tello_parameters_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int tello_parameters_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t tello_parameters_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* tello_parameters_lcmt::getTypeName()
{
    return "tello_parameters_lcmt";
}

int tello_parameters_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int tello_parameters_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int tello_parameters_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t tello_parameters_lcmt::_computeHash(const __lcm_hash_ptr *)
{
