...
#ifndef __spi_data_lcmt_hpp__
#define __spi_data_lcmt_hpp__
...
int spi_data_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int spi_data_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int spi_data_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t spi_data_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* spi_data_lcmt::getTypeName()
{
    return "spi_data_lcmt";
}

int spi_data_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int spi_data_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int spi_data_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t spi_data_lcmt::_computeHash(const __lcm_hash_ptr *)
{
