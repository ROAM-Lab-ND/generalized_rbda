...
#ifndef __landingTO_input_lcmt_hpp__
#define __landingTO_input_lcmt_hpp__

#include <lcm/lcm_coretypes.h>



class landingTO_input_lcmt
{
    public:
        double     falling_conditions[9];
...
int landingTO_input_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int landingTO_input_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int landingTO_input_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t landingTO_input_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* landingTO_input_lcmt::getTypeName()
{
    return "landingTO_input_lcmt";
}

int landingTO_input_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;

    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->falling_conditions[0], 9);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->Xref[0], 252);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->Uref[0], 480);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->dt_opt[0], 20);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->c_init[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->jpos_min[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->jpos_max[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->kin_box[0], 2);
    if(tlen < 0) return tlen; else pos += tlen;
...
int landingTO_input_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;

    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->falling_conditions[0], 9);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->Xref[0], 252);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->Uref[0], 480);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->dt_opt[0], 20);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->c_init[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->jpos_min[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->jpos_max[0], 12);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->kin_box[0], 2);
    if(tlen < 0) return tlen; else pos += tlen;
...
int landingTO_input_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
    enc_size += __double_encoded_array_size(NULL, 9);
    enc_size += __double_encoded_array_size(NULL, 252);
    enc_size += __double_encoded_array_size(NULL, 480);
...
uint64_t landingTO_input_lcmt::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x67286e14bdaa9318LL;
