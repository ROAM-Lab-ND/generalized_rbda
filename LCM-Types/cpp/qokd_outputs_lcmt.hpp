...
#ifndef __qokd_outputs_lcmt_hpp__
#define __qokd_outputs_lcmt_hpp__
...
int qokd_outputs_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int qokd_outputs_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int qokd_outputs_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t qokd_outputs_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* qokd_outputs_lcmt::getTypeName()
{
    return "qokd_outputs_lcmt";
}

int qokd_outputs_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int qokd_outputs_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int qokd_outputs_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t qokd_outputs_lcmt::_computeHash(const __lcm_hash_ptr *)
{
