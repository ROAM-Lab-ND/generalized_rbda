...
#ifndef __taqokd_inputs_lcmt_hpp__
#define __taqokd_inputs_lcmt_hpp__
...
class taqokd_inputs_lcmt
{
    public:
        ...
        double     terrain_z_height_actual;

        double     terrain_z_height;

        double     terrain_x_shift_actual;

        double     terrain_x_shift;

        double     terrain_steepness;

        double     terrain_y_angle;

        double     terrain_y_curvature;
...
int taqokd_inputs_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int taqokd_inputs_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int taqokd_inputs_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t taqokd_inputs_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* taqokd_inputs_lcmt::getTypeName()
{
    return "taqokd_inputs_lcmt";
}

int taqokd_inputs_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->r_land_xy_sf[0], 2);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->terrain_z_height_actual, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->terrain_z_height, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->terrain_x_shift_actual, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->terrain_x_shift, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->terrain_steepness, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->terrain_y_angle, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->terrain_y_curvature, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int taqokd_inputs_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->r_land_xy_sf[0], 2);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->terrain_z_height_actual, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->terrain_z_height, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->terrain_x_shift_actual, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->terrain_x_shift, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->terrain_steepness, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->terrain_y_angle, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->terrain_y_curvature, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int taqokd_inputs_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t taqokd_inputs_lcmt::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x0b822b6405fb66c1LL;
