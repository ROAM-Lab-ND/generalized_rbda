...
#ifndef __quadruped_parameters_lcmt_hpp__
#define __quadruped_parameters_lcmt_hpp__
...
class quadruped_parameters_lcmt
{
    ...
    public:
        ...
        /**
         * Returns "quadruped_parameters_lcmt"
         */
...
int quadruped_parameters_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int quadruped_parameters_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int quadruped_parameters_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t quadruped_parameters_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* quadruped_parameters_lcmt::getTypeName()
{
    return "quadruped_parameters_lcmt";
}

int quadruped_parameters_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int quadruped_parameters_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int quadruped_parameters_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t quadruped_parameters_lcmt::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x88279a1f772681d7LL;
