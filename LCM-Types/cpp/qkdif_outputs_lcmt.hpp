...
#ifndef __qkdif_outputs_lcmt_hpp__
#define __qkdif_outputs_lcmt_hpp__
...
int qkdif_outputs_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int qkdif_outputs_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int qkdif_outputs_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t qkdif_outputs_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* qkdif_outputs_lcmt::getTypeName()
{
    return "qkdif_outputs_lcmt";
}

int qkdif_outputs_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->t_NN_eval, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int qkdif_outputs_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->t_NN_eval, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int qkdif_outputs_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t qkdif_outputs_lcmt::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x0f825d87a60d5262LL;
