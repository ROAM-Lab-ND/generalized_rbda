...
#ifndef __jto_outputs_casadi_lcmt_hpp__
#define __jto_outputs_casadi_lcmt_hpp__
...
class jto_outputs_casadi_lcmt
{
    ...
    public:
        ...
        /**
         * Returns "jto_outputs_casadi_lcmt"
         */
...
int jto_outputs_casadi_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int jto_outputs_casadi_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int jto_outputs_casadi_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t jto_outputs_casadi_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* jto_outputs_casadi_lcmt::getTypeName()
{
    return "jto_outputs_casadi_lcmt";
}

int jto_outputs_casadi_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int jto_outputs_casadi_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int jto_outputs_casadi_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t jto_outputs_casadi_lcmt::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xf852c5d4497f4178LL;
