...
#ifndef __spi_command_lcmt_hpp__
#define __spi_command_lcmt_hpp__

#include <lcm/lcm_coretypes.h>



class spi_command_lcmt
{
    public:
        float      q_des_abad[4];
...
int spi_command_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int spi_command_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int spi_command_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t spi_command_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* spi_command_lcmt::getTypeName()
{
    return "spi_command_lcmt";
}

int spi_command_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int spi_command_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int spi_command_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t spi_command_lcmt::_computeHash(const __lcm_hash_ptr *)
{
