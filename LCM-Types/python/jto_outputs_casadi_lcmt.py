...
class jto_outputs_casadi_lcmt(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(jto_outputs_casadi_lcmt._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != jto_outputs_casadi_lcmt._get_packed_fingerprint():
            raise ValueError("Decode error")
        return jto_outputs_casadi_lcmt._decode_one(buf)
    decode = staticmethod(decode)

    def _decode_one(buf):
        self = jto_outputs_casadi_lcmt()
    ...
    def _get_hash_recursive(parents):
        if jto_outputs_casadi_lcmt in parents: return 0
    ...
    def _get_packed_fingerprint():
        if jto_outputs_casadi_lcmt._packed_fingerprint is None:
            jto_outputs_casadi_lcmt._packed_fingerprint = struct.pack(">Q", jto_outputs_casadi_lcmt._get_hash_recursive([]))
        return jto_outputs_casadi_lcmt._packed_fingerprint
