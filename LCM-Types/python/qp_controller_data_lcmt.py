...
class qp_controller_data_lcmt(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(qp_controller_data_lcmt._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != qp_controller_data_lcmt._get_packed_fingerprint():
            raise ValueError("Decode error")
        return qp_controller_data_lcmt._decode_one(buf)
    decode = staticmethod(decode)

    def _decode_one(buf):
        self = qp_controller_data_lcmt()
    ...
    def _get_hash_recursive(parents):
        if qp_controller_data_lcmt in parents: return 0
    ...
    def _get_packed_fingerprint():
        if qp_controller_data_lcmt._packed_fingerprint is None:
            qp_controller_data_lcmt._packed_fingerprint = struct.pack(">Q", qp_controller_data_lcmt._get_hash_recursive([]))
        return qp_controller_data_lcmt._packed_fingerprint
