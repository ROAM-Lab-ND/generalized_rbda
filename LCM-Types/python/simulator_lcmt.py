...
class simulator_lcmt(object):
    __slots__ = ["vb", "rpy", "timesteps", "time", "quat", "R", "omegab", "omega", "p", "v", "vbd", "q", "qHleg", "qd", "qdHleg", "qdd", "tau", "f_foot", "p_foot"]

    __typenames__ = ["double", "double", "int64_t", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double"]

    __dimensions__ = [[3], [3], None, None, [4], [3, 3], [3], [3], [3], [3], [3], [4, 3], [2, 5], [4, 3], [2, 5], [4, 3], [4, 3], [4, 3], [4, 3]]
    ...
    def __init__(self):
        ...
        self.qHleg = [ [ 0.0 for dim1 in range(5) ] for dim0 in range(2) ]
        self.qd = [ [ 0.0 for dim1 in range(3) ] for dim0 in range(4) ]
        self.qdHleg = [ [ 0.0 for dim1 in range(5) ] for dim0 in range(2) ]
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(2):
            buf.write(struct.pack('>5d', *self.qHleg[i0][:5]))
        for i0 in range(4):
            buf.write(struct.pack('>3d', *self.qd[i0][:3]))
        for i0 in range(2):
            buf.write(struct.pack('>5d', *self.qdHleg[i0][:5]))
        for i0 in range(4):
    ...
    def _decode_one(buf):
        ...
        self.qHleg = []
        for i0 in range(2):
            self.qHleg.append(struct.unpack('>5d', buf.read(40)))
        self.qd = []
        for i0 in range(4):
            self.qd.append(struct.unpack('>3d', buf.read(24)))
        self.qdHleg = []
        for i0 in range(2):
            self.qdHleg.append(struct.unpack('>5d', buf.read(40)))
        self.qdd = []
        for i0 in range(4):
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x803bde20547b706e) & 0xffffffffffffffff
