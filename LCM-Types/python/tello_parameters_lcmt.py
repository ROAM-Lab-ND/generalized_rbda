...
class tello_parameters_lcmt(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(tello_parameters_lcmt._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != tello_parameters_lcmt._get_packed_fingerprint():
            raise ValueError("Decode error")
        return tello_parameters_lcmt._decode_one(buf)
    decode = staticmethod(decode)

    def _decode_one(buf):
        self = tello_parameters_lcmt()
    ...
    def _get_hash_recursive(parents):
        if tello_parameters_lcmt in parents: return 0
    ...
    def _get_packed_fingerprint():
        if tello_parameters_lcmt._packed_fingerprint is None:
            tello_parameters_lcmt._packed_fingerprint = struct.pack(">Q", tello_parameters_lcmt._get_hash_recursive([]))
        return tello_parameters_lcmt._packed_fingerprint
