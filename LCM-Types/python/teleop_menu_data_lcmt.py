...
class teleop_menu_data_lcmt(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(teleop_menu_data_lcmt._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != teleop_menu_data_lcmt._get_packed_fingerprint():
            raise ValueError("Decode error")
        return teleop_menu_data_lcmt._decode_one(buf)
    decode = staticmethod(decode)

    def _decode_one(buf):
        self = teleop_menu_data_lcmt()
    ...
    def _get_hash_recursive(parents):
        if teleop_menu_data_lcmt in parents: return 0
    ...
    def _get_packed_fingerprint():
        if teleop_menu_data_lcmt._packed_fingerprint is None:
            teleop_menu_data_lcmt._packed_fingerprint = struct.pack(">Q", teleop_menu_data_lcmt._get_hash_recursive([]))
        return teleop_menu_data_lcmt._packed_fingerprint
