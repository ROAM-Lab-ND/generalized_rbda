...
class microstrain_lcmt(object):
    __slots__ = ["quat", "rpy", "omega", "acc", "lcm_published_timestamp", "good_packets", "bad_packets"]

    __typenames__ = ["float", "float", "float", "float", "int64_t", "int64_t", "int64_t"]

    __dimensions__ = [[4], [3], [3], [3], None, None, None]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack(">qqq", self.lcm_published_timestamp, self.good_packets, self.bad_packets))
    ...
    def _decode_one(buf):
        ...
        self.lcm_published_timestamp, self.good_packets, self.bad_packets = struct.unpack(">qqq", buf.read(24))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xe40c2cc978338f68) & 0xffffffffffffffff
