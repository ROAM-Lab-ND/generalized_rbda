...
class leg_control_data_lcmt(object):
    __slots__ = ["q", "qd", "p", "v", "tau_est", "tau_act"]
    ...
    def __init__(self):
        ...
        self.tau_act = [ 0.0 for dim0 in range(12) ]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>12f', *self.tau_act[:12]))
    ...
    def _decode_one(buf):
        ...
        self.tau_act = struct.unpack('>12f', buf.read(48))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xc1debc79b6653dd7) & 0xffffffffffffffff
