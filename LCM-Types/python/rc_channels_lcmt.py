...
class rc_channels_lcmt(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(rc_channels_lcmt._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != rc_channels_lcmt._get_packed_fingerprint():
            raise ValueError("Decode error")
        return rc_channels_lcmt._decode_one(buf)
    decode = staticmethod(decode)

    def _decode_one(buf):
        self = rc_channels_lcmt()
    ...
    def _get_hash_recursive(parents):
        if rc_channels_lcmt in parents: return 0
    ...
    def _get_packed_fingerprint():
        if rc_channels_lcmt._packed_fingerprint is None:
            rc_channels_lcmt._packed_fingerprint = struct.pack(">Q", rc_channels_lcmt._get_hash_recursive([]))
        return rc_channels_lcmt._packed_fingerprint
