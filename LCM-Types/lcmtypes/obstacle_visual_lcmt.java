...
public final class obstacle_visual_lcmt implements lcm.lcm.LCMEncodable
{
    public int num_obs;
    ...
    {
        if (classes.contains(lcmtypes.obstacle_visual_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.obstacle_visual_lcmt.class);
    ...
    public obstacle_visual_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public obstacle_visual_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.obstacle_visual_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
