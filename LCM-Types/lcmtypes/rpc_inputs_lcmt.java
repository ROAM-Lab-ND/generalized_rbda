...
public final class rpc_inputs_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmtypes.rpc_inputs_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.rpc_inputs_lcmt.class);
    ...
    public rpc_inputs_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public rpc_inputs_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.rpc_inputs_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
