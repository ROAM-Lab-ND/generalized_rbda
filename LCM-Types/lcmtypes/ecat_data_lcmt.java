...
public final class ecat_data_lcmt implements lcm.lcm.LCMEncodable
{
    public float x[];
    public float y[];
    public float z[];
    ...
    {
        if (classes.contains(lcmtypes.ecat_data_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.ecat_data_lcmt.class);
    ...
    public ecat_data_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public ecat_data_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.ecat_data_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
