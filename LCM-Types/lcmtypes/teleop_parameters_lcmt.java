...
public final class teleop_parameters_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmtypes.teleop_parameters_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.teleop_parameters_lcmt.class);
    ...
    public teleop_parameters_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public teleop_parameters_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.teleop_parameters_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
