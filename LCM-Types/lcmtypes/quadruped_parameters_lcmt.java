...
public final class quadruped_parameters_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    public static final long LCM_FINGERPRINT_BASE = 0x88279a1f772681d7L;
    ...
    {
        if (classes.contains(lcmtypes.quadruped_parameters_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.quadruped_parameters_lcmt.class);
    ...
    public quadruped_parameters_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public quadruped_parameters_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.quadruped_parameters_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
