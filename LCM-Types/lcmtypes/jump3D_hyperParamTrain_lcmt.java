...
public final class jump3D_hyperParamTrain_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    public static final long LCM_FINGERPRINT_BASE = 0x632d8dd376b71320L;
    ...
    {
        if (classes.contains(lcmtypes.jump3D_hyperParamTrain_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.jump3D_hyperParamTrain_lcmt.class);
    ...
    public void _encodeRecursive(DataOutput outs) throws IOException
    {
        ...
        outs.writeDouble(this.yaw_takeoff); 
 
        outs.writeDouble(this.px_flight); 
 
        outs.writeDouble(this.yaw_flight); 
        ...
        outs.writeInt(this.b_use_wbc_takeoff); 
        ...
        outs.writeInt(this.max_train_iter); 
 
    }
 
    public jump3D_hyperParamTrain_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public jump3D_hyperParamTrain_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.jump3D_hyperParamTrain_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.b_use_wbc_takeoff = ins.readInt();
        ...
        this.max_train_iter = ins.readInt();
