...
public final class qokd_outputs_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmtypes.qokd_outputs_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.qokd_outputs_lcmt.class);
    ...
    public qokd_outputs_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public qokd_outputs_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.qokd_outputs_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
