...
public final class rpc_outputs_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmtypes.rpc_outputs_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.rpc_outputs_lcmt.class);
    ...
    public rpc_outputs_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public rpc_outputs_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.rpc_outputs_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
