...
public final class tello_menu_data_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmtypes.tello_menu_data_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.tello_menu_data_lcmt.class);
    ...
    public tello_menu_data_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public tello_menu_data_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.tello_menu_data_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
