...
public final class spi_command_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmtypes.spi_command_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.spi_command_lcmt.class);
    ...
    public spi_command_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public spi_command_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.spi_command_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
