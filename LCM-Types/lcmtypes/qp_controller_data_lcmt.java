...
public final class qp_controller_data_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmtypes.qp_controller_data_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.qp_controller_data_lcmt.class);
    ...
    public qp_controller_data_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public qp_controller_data_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.qp_controller_data_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
