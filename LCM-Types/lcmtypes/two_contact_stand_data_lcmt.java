...
public final class two_contact_stand_data_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmtypes.two_contact_stand_data_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.two_contact_stand_data_lcmt.class);
    ...
    public two_contact_stand_data_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public two_contact_stand_data_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.two_contact_stand_data_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
