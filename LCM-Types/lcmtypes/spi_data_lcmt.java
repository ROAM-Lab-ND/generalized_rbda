...
public final class spi_data_lcmt implements lcm.lcm.LCMEncodable
{
    public float q_abad[];
    public float q_hip[];
    public float q_knee[];
    ...
    {
        if (classes.contains(lcmtypes.spi_data_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.spi_data_lcmt.class);
    ...
    public spi_data_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public spi_data_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.spi_data_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
