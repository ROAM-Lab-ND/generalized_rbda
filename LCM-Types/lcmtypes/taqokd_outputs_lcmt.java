...
public final class taqokd_outputs_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmtypes.taqokd_outputs_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.taqokd_outputs_lcmt.class);
    ...
    public taqokd_outputs_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public taqokd_outputs_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.taqokd_outputs_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
