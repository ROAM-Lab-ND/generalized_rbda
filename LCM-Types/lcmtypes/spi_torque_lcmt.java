...
public final class spi_torque_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmtypes.spi_torque_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.spi_torque_lcmt.class);
    ...
    public spi_torque_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public spi_torque_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.spi_torque_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
