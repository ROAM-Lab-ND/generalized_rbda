...
public final class simulator_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    public static final long LCM_FINGERPRINT_BASE = 0x803bde20547b706eL;
    ...
    public void _encodeRecursive(DataOutput outs) throws IOException
    {
        ...
        for (int a = 0; a < 2; a++) {
            for (int b = 0; b < 5; b++) {
                outs.writeDouble(this.qHleg[a][b]); 
            }
        }
        ...
        for (int a = 0; a < 2; a++) {
            for (int b = 0; b < 5; b++) {
                outs.writeDouble(this.qdHleg[a][b]); 
            }
        }
    ...
    public lcmtypes.simulator_lcmt copy()
    {
        ...
        for (int a = 0; a < 2; a++) {
            System.arraycopy(this.qHleg[a], 0, outobj.qHleg[a], 0, 5);        }
        ...
        for (int a = 0; a < 2; a++) {
            System.arraycopy(this.qdHleg[a], 0, outobj.qdHleg[a], 0, 5);        }
