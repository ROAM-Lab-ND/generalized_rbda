...
public final class teleop_menu_data_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(lcmtypes.teleop_menu_data_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.teleop_menu_data_lcmt.class);
    ...
    public teleop_menu_data_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public teleop_menu_data_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.teleop_menu_data_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
