...
public final class ecat_command_lcmt implements lcm.lcm.LCMEncodable
{
    public float x_des[];
    public float y_des[];
    public float z_des[];
    ...
    {
        if (classes.contains(lcmtypes.ecat_command_lcmt.class))
            return 0L;
 
        classes.add(lcmtypes.ecat_command_lcmt.class);
    ...
    public ecat_command_lcmt(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public ecat_command_lcmt(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.ecat_command_lcmt _decodeRecursiveFactory(DataInput ins) throws IOException
    {
