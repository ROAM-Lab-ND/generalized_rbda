...
class ContactConstraint {
 public:
   ...
   */
  size_t AddCollision(Collision<T>* collision) {
    _collision_list.push_back(collision);
    ++_nCollision;
    return (_nCollision-1);
  }
   ...
   */
  void RemoveCollision(size_t collision_idx) {
    _collision_list.erase(_collision_list.begin()+collision_idx);
    --_nCollision;
  }
