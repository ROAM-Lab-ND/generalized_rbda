...
namespace grbda
{
    ...
    ClusterTreeModel<Scalar> MIT_Humanoid_Leg<Scalar>::buildClusterTreeModel() const
    {
        ...
        SpatialInertia<Scalar> hip_rz_rotor_inertia(0., this->_smallRotorCOM,
                                                    this->_smallRotorRotInertiaZ);
        ...
        SpatialInertia<Scalar> hip_rx_rotor_inertia(0., this->_smallRotorCOM,
                                                    this->_smallRotorRotInertiaX);
        ...
        SpatialInertia<Scalar> hip_ry_rotor_inertia(0., this->_largeRotorCOM,
                                                    this->_largeRotorRotInertiaY);
        ...
        SpatialInertia<Scalar> knee_rotor_inertia(0., this->_largeRotorCOM,
                                                  this->_largeRotorRotInertiaY);
        ...
        SpatialInertia<Scalar> ankle_rotor_inertia(0., this->_smallRotorCOM,
                                                   this->_smallRotorRotInertiaY);
